...
(3, '2017-01-17', '8:00pm', 'Some concert... TBA', 2, 'TBA');
...
INSERT INTO `ticket` (`ticket_id`, `price`, `available`, `etes_commission`, `seat`, `user_id`, `event_id`) VALUES
(1, 50, 1, 2.5, 'B11', 22, 1),
(3, 1, 1, 1, 'e1', 21, 3);
...
(20, '123', '123', '1980-01-01', 'zxghfg', '12334', '123', 'da43', 12345),
(21, 'mom@email.com', 'password', '1981-02-03', 'your', 'mom', '1234', 'daly city', 94015),
(22, 'kdot', 'password', '1986-01-01', 'Kendrick', 'Lamar', '123', 'Compton', 12345);
...
(2, 'SAP Center', '525 W Santa Clara St, San Jose, CA 95113', '');
